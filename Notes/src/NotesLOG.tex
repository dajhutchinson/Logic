...
\definition{Extension of Substitution}
...
\proposition{Extension to Substitutability}
\[\begin{array}{rl}
...
\remark{I have missed some from 3.3.14 but have covered in ReviewedNotesLOG}

\section{Deductive Systems for First-Order Predicate Logic}

\remark{Structure of Mathetmical Proofs}
...
\definition{Logical Axioms of Hilbert Calculus}
Let $\LL$ be a FOL.\\
...
\begin{enumerate}
	\item $\D_m:=\langle \phi_1,\phi_m\rangle$ is a deduction of $\phi_m$ from $\Gamma$ for $m\in[1,n]$ %Some weird symbol used in notes but i think a typo
