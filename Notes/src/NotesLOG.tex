...
\definition{$\mathcal{L}$-Formulae \& Complexity}
...
\example{\textit{$\mathcal{L}$-Formulae} Complexity}
...
\notationn{Sets of $\mathcal{L}$ Features}
\begin{itemize}
...
\proposition{$T_\mathcal{M_L}\ \&\ F_\mathcal{M_L}$ are always countable in this course since we assume $\mathcal{L}$ to be finite.}

\subsection{Induction of Terms \& Formulae}

\theorem{Inheritance of a Proeprty - $\mathcal{L}$-Terms}
...
\theorem{Inheritance of a Proeprty - $\mathcal{L}$-Formulae}
